...
public class ItemStackUtil {
    ...
    public static TagKey<Item> noNbt = TagKey.create(ForgeRegistries.ITEMS.getRegistryKey(), new ResourceLocation(MaidStorageManager.MODID, "no_nbt"));
    public static TagKey<Item> matchNbt = TagKey.create(ForgeRegistries.ITEMS.getRegistryKey(), new ResourceLocation(MaidStorageManager.MODID, "use_nbt"));
    ...
    public static boolean isSameInCrafting(ItemStack stack1, ItemStack stack2) {
        ...
        if (stack1.is(noNbt)) matchTag = false;
        if (stack1.is(matchNbt)) matchTag = true;
