...
public class CommunicateMarkScreen extends AbstractFilterScreen<CommunicateMarkMenu> {
    ...
    SelectButtonWidget<Identifier> btnManual;
    ...
    public CommunicateMarkScreen(CommunicateMarkMenu p_97741_, Inventory p_97742_, Component p_97743_) {
        super(p_97741_, p_97742_, p_97743_, 176, 246);
    ...
    @Override
    public void extractRenderState(@NotNull GuiGraphicsExtractor graphics, int x, int y, float pt) {
        super.extractRenderState(graphics, x, y, pt);
    ...
    @Override
    public void extractBackground(@NotNull GuiGraphicsExtractor graphics, int p_97789_, int p_97790_, float p_97788_) {
    ...
    public boolean mouseClicked(MouseButtonEvent event, boolean doubleClick) {
        ...
        if (selector.visible) {
            if (selector.isMouseOver(p_97748_, p_97749_))
                return selector.mouseClicked(event, doubleClick);
            else {
        ...
        if (methodSelector.visible) {
            if (methodSelector.isMouseOver(p_97748_, p_97749_))
                return methodSelector.mouseClicked(event, doubleClick);
            else {
