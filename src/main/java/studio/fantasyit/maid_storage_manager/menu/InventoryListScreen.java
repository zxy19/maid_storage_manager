...
public class InventoryListScreen extends Screen {
    ...
    @Override
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int x, int y, float p_282465_) {

        super.extractRenderState(guiGraphics, x, y, p_282465_);
        for (int i = 0; i < this.rows; i++) {
            for (int j = 0; j < this.columns; j++) {
                ...
                if (index < list.size()) {
                    ...
                    guiGraphics.itemDecorations(this.font, item, ix, iy);
