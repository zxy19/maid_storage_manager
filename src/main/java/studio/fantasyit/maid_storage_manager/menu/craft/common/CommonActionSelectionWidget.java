...
public class CommonActionSelectionWidget extends AbstractWidget {
    private final static Identifier background = Identifier.fromNamespaceAndPath(MaidStorageManager.MODID, "textures/gui/craft/type/common.png");
    ...
    public void extractWidgetRenderState(GuiGraphicsExtractor guiGraphics, int x, int y, float pt) {
        ...
        for (SelectButtonWidget<CraftAction> button : buttons) {
            button.extractWidgetRenderState(guiGraphics, x, y, pt);
            CommonCraftAssets
