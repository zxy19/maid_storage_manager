...
@IPNIgnore
public class CraftingTableCraftScreen extends AbstractFilterScreen<CraftingTableCraftMenu> implements ICraftGuiPacketReceiver {
    private final ResourceLocation background = new ResourceLocation(MaidStorageManager.MODID, "textures/gui/craft/type/crafting.png");
