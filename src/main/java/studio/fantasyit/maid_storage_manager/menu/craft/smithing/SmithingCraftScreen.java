...
@IPNIgnore
public class SmithingCraftScreen extends AbstractFilterScreen<SmithingCraftMenu> implements ICraftGuiPacketReceiver {
    private final ResourceLocation background = new ResourceLocation(MaidStorageManager.MODID, "textures/gui/craft/type/smithing.png");
