...
@IPNIgnore
public class FurnaceCraftScreen extends AbstractFilterScreen<FurnaceCraftMenu> implements ICraftGuiPacketReceiver {
    private final ResourceLocation background = new ResourceLocation(MaidStorageManager.MODID, "textures/gui/craft/type/furnace.png");
