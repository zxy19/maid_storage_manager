...
import studio.fantasyit.maid_storage_manager.maid.behavior.communicate.MaidCommunicateCheckBehavior;
...
public class StorageManageTask implements IMaidTask, ICommunicatable {
    public static Identifier TASK_ID = Identifier.fromNamespaceAndPath(MaidStorageManager.MODID, "storage_manage");
    ...
    public @NotNull List<Pair<Integer, BehaviorControl<? super EntityMaid>>> createBrainTasks(EntityMaid entityMaid) {
        ...
        list.add(Pair.of(5, new MaidCommunicateCheckBehavior()));
        return list;
    }
    ...
    @Override
    public Set<Identifier> getAcceptedWishTypes() {
        return Set.of(
                PlaceItemWish.TYPE,
