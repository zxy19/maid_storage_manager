...
public class ChatTexts {
    ...
    public static final String CHAT_REQUEST_FINISH = "chat_bubbles.maid_storage_manager.request_finish";
    ...
    public static final String CHAT_CRAFT_RESULT = "chat_bubbles.maid_storage_manager.crafting_result";
