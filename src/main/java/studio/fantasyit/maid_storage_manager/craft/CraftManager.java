...
public class CraftManager {
    ...
    protected Map<Identifier, ICraftType> typesMap;
    protected List<CraftAction> actions;
    protected Map<Identifier, CraftAction> actionsMap;
    protected List<IAutoCraftGuideGenerator> autoCraftGuideGenerators;
    protected Map<Identifier, List<BiPredicate<ItemStack, ItemStack>>> itemStackPredicates;
    ...
    public void collect() {
        ...
        Map<Identifier, List<BiPredicate<ItemStack, ItemStack>>> itemStackPredicates = new HashMap<>();
...
//        }
    ...
    public @Nullable ICraftType getType(Identifier type) {
    ...
    public @Nullable AbstractCraftActionContext start(Identifier type, EntityMaid maid, CraftGuideData craftGuideData, CraftGuideStepData craftGuideStepData, CraftLayer layer) {
    ...
    public @NotNull CraftAction getAction(Identifier type) {
        return Objects.requireNonNull(this.actionsMap.get(type));
    }

    public @Nullable Identifier getTargetType(ServerLevel level, BlockPos pos, Direction direction) {
        for (ICraftType type : this.types) {
