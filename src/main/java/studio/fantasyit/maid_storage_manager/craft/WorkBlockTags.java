...
public class WorkBlockTags {
    public static TagKey<Block> CRAFTING_TABLE = TagKey.create(
            ...
            new ResourceLocation(MaidStorageManager.MODID, "working_block/crafting_table")
    );
    public static TagKey<Block> FURNACE = TagKey.create(
            ForgeRegistries.BLOCKS.getRegistryKey(),
            new ResourceLocation(MaidStorageManager.MODID, "working_block/furnace")
    );
    public static TagKey<Block> BREWING_STAND = TagKey.create(
            ForgeRegistries.BLOCKS.getRegistryKey(),
            new ResourceLocation(MaidStorageManager.MODID, "working_block/brewing_stand")
    );
    public static TagKey<Block> SMITHING_TABLE = TagKey.create(
            ForgeRegistries.BLOCKS.getRegistryKey(),
            new ResourceLocation(MaidStorageManager.MODID, "working_block/smithing_table")
    );
    public static TagKey<Block> STONE_CUTTER = TagKey.create(
            ForgeRegistries.BLOCKS.getRegistryKey(),
            new ResourceLocation(MaidStorageManager.MODID, "working_block/stone_cutter")
    );
}
